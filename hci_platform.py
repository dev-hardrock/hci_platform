...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.btn_cmd.setGeometry(QtCore.QRect(10, 660, 100, 25))
        self.btn_cmd.setObjectName("btn_cmd")
        self.btn_clear = QtWidgets.QPushButton(Form)
        self.btn_clear.setGeometry(QtCore.QRect(130, 660, 50, 25))
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Hci_PlatForm"))
